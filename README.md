...
Port of the Hugo Parsa Theme developed by Themefischer for Forestry CMS.
...
![Forestry user interface](images/hugo-parsa-forestry.jpg)
...
You can customize the theme through the [`config.toml` file](https://github.com/forestryio/hugo-parsa-forestry/blob/forestry/config.toml). Those values are accessible from within Forestry.
...
git clone git@github.com:forestryio/hugo-parsa-forestry.git
